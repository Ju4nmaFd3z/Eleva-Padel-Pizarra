  ...
  window.__ELEVA_I18N__ = {
    ...
    es: {
      ...
      club: {
        ...
        tournaments: 'Torneos',
        tournamentsDesc: 'Pools por categoría: SNP · 3ª · 4ª · 5ª · Mixta · Rocha<br>Horarios variables — plazas por WhatsApp'
      },
      services: {
        ...
        desc3: 'Pools por categoría: SNP, 3ª, 4ª, 5ª, Mixta y Rocha. Precio fijo, buen rollo garantizado. Liga interna y torneos para todos los niveles.',
    ...
    en: {
      ...
      club: {
        ...
        tournamentsDesc: 'Pools by category: SNP · 3rd · 4th · 5th · Mixed · Rocha<br>Variable schedule — spots via WhatsApp'
      },
      services: {
        ...
        desc3: 'Pools by category: SNP, 3rd, 4th, 5th, Mixed and Rocha. Fixed price, great atmosphere guaranteed. Internal league and tournaments for all levels.',
        cta3: 'Join the group',
    ...
    nl: {
      ...
      club: {
        ...
        tournamentsDesc: 'Pools per categorie: SNP · 3e · 4e · 5e · Gemengd · Rocha<br>Wisselende tijden — plaatsen via WhatsApp'
      },
      services: {
        ...
        desc3: 'Pools per categorie: SNP, 3e, 4e, 5e, Gemengd en Rocha. Vaste prijs, geweldige sfeer gegarandeerd. Interne competitie en toernooien voor alle niveaus.',
