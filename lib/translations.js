  ...
  window.__ELEVA_I18N__ = {
    ...
    es: {
      ...
      nav: {
        ...
        contact: 'Contacto', book: 'Reservar', bookCourt: 'Reservar pista',
      ...
      hero: {
        kicker: 'PADEL CLUB · 4 PISTAS OUTDOOR · PIZARRA · MÁLAGA',
      ...
      marquee: {
        ...
        location: 'Pizarra, Málaga', tag: 'High Performance & Social Club'
      },
      torneo: {
        flag: 'I TORNEO ELEVA',
        text: '24–28 Junio 2026 · 7 categorías · 25€/jugador · Welcome Pack incluido',
        cta: 'Inscribirse en Vola',
        ariaLabel: 'Próximo evento'
      },
      club: {
        label: 'El Club', aside: 'EST · 2026 · PIZARRA · MÁLAGA',
        headingHtml: 'Un club con más futuro<br>que presente.',
        courts: 'Pistas', courtsDesc: '4 outdoor panorámicas con iluminación LED',
        schedule: 'Horario', scheduleValue: 'L–D · 9:00–00:00', bookings: 'Reservas',
        community: 'Comunidad', communityLink: 'Grupo WhatsApp activo',
        tournaments: 'Torneos',
        tournamentsDesc: 'SNP Viernes 21:30 · 4ª Masc. Viernes 20:20<br>Mixta Jueves 20:00 · Rocha Martes 20:00'
      },
      services: {
        srHeading: 'Servicios de Eleva Padel Club',
        cat1: 'Instalaciones', title1: 'Pistas', sub1: 'Juega. Cualquier hora.',
        ...
        desc2: 'Grupos de 3–4 personas, monitores federados, 1h de técnica real. Clases para todos los niveles, desde iniciación hasta competición. Sesiones de prueba disponibles.',
        cta2: 'Consultar plazas',
        cat3: 'Competición', title3: 'Pools', sub3: 'Compite toda la semana.',
        desc3: 'Pools por categoría: SNP, 4ª, Mixta, Rocha. Precio fijo, buen rollo garantizado. Liga interna y torneos para todos los niveles.',
      ...
      academy: {
        ...
        level2: 'Intermedio', card2Title: 'Consolida y táctica real.',
        ...
        adults1dt: 'Grupo 4 personas · 1 día/sem', adults2dt: 'Grupo 3 personas', adults3dt: 'Grupo 2 personas',
        ...
        ctaNoteHtml: 'Grupos organizados por nivel y disponibilidad.<br><strong>Plazas limitadas</strong> · Monitores federados · Todos los niveles',
        ctaBtn: 'Consultar plazas'
      },
      team: {
        label: 'El Equipo',
        headingHtml: 'Las personas<br><em>detrás del club.</em>',
        role1: 'Monitora · Jugadora Profesional',
        bio1: 'Jugadora de pádel profesional de reconocido prestigio e imagen del club. Referente técnico de la academia de Eleva Padel Club.',
      ...
      pools: {
        ...
        active: 'Activa',
        snpDay: 'Viernes',   snpTime: '21:30 – 23:00',
        m4Day:  'Viernes',   m4Time:  '20:20 – 21:50',
        mixDay: 'Jueves',    mixTime: '20:00 – 21:30',
        rochaDay: 'Martes',  rochaTime: '20:00 – 21:30',
        snpDesc: 'Sin par absoluto. Para quienes quieren saber exactamente dónde están.',
        m4Desc:  'Cuarta categoría masculina. Nivel parejo, partido garantizado.',
        mixDesc: 'Mixta abierta. El mejor ambiente de la semana.',
        rochaDesc: 'Categoría Rocha. Competición real, buen rollo también.',
        perksLabel: 'Todos los pools incluyen',
        include: 'Bolas nuevas · 1h30 · Inscripción por WhatsApp',
        prizeLabel: 'Premio ganadores',
        prize: 'Camiseta BullPadel con logo del club',
        quote: '«Hay lugares con más futuro que presente.»',
        cta:   'Apuntarse al próximo pool'
      },
      sponsors: {
        label: 'Patrocinadores',
        ariaLabel: 'Patrocinadores principales',
        headlineHtml: 'Sin ellos,<br><em>no hay pistas.</em>',
        sub: 'Cuatro empresas apostaron por este proyecto cuando era solo una idea. Son los cimientos reales del club, y cada pista lleva su nombre.',
        badge: 'Patrocinador Principal',
        soon: 'Próximamente',
        soonBadge: '¿Tu empresa aquí?',
      },
      gallery: {
        heading: 'El club.', subtitle: 'Pizarra · Málaga · Est. 2026',
      ...
      contact: {
        ...
        labelLevel: 'Nivel', labelMessage: 'Mensaje (opcional)',
        ...
        formNote: 'Te redirige a WhatsApp con los datos rellenados. Respuesta en &lt;24h.',
      ...
      wa: {
        ...
        prueba:   'Hola, me interesa una sesión de prueba en la academia de Eleva Padel Club.',
        pool:     '¡Hola! Me gustaría apuntarme al próximo pool de Eleva Padel Club 🎾',
    ...
    en: {
      ...
      nav: {
        ...
        contact: 'Contact', book: 'Book', bookCourt: 'Book a court',
      ...
      hero: {
        kicker: 'PADEL CLUB · 4 OUTDOOR COURTS · PIZARRA · MÁLAGA',
      ...
      torneo: {
        flag: 'I ELEVA TOURNAMENT',
        text: '24–28 June 2026 · 7 categories · €25/player · Welcome Pack included',
        cta: 'Register on Vola',
        ariaLabel: 'Upcoming event'
      },
      club: {
        label: 'The Club', aside: 'EST · 2026 · PIZARRA · MÁLAGA',
        headingHtml: 'A club with more future<br>than present.',
        courts: 'Courts', courtsDesc: '4 panoramic outdoor courts with LED lighting',
        schedule: 'Hours', scheduleValue: 'Mon–Sun · 9:00–midnight', bookings: 'Bookings',
        community: 'Community', communityLink: 'Active WhatsApp group',
        tournaments: 'Tournaments',
        tournamentsDesc: 'SNP Friday 21:30 · 4th Men\'s Friday 20:20<br>Mixed Thursday 20:00 · Rocha Tuesday 20:00'
      },
      services: {
        ...
        desc2: 'Groups of 3–4 people, certified coaches, 1h of real technique. Classes for all levels, from beginner to competition. Trial sessions available.',
        cta2: 'Check availability',
        cat3: 'Competition', title3: 'Pools', sub3: 'Compete all week long.',
        desc3: 'Pools by category: SNP, 4th, Mixed, Rocha. Fixed price, great atmosphere guaranteed. Internal league and tournaments for all levels.',
        cta3: 'Join the group',
      ...
      academy: {
        ...
        level2: 'Intermediate', card2Title: 'Consolidate and real tactics.',
        ...
        adults1dt: 'Group of 4 · 1 day/week', adults2dt: 'Group of 3', adults3dt: 'Group of 2',
        ...
        ctaNoteHtml: 'Groups organised by level and availability.<br><strong>Limited spots</strong> · Certified coaches · All levels',
        ctaBtn: 'Check availability'
      },
      team: {
        label: 'The Team',
        headingHtml: 'The people<br><em>behind the club.</em>',
        role1: 'Coach · Professional Player',
        bio1: 'Professional padel player of renowned prestige and the face of the club. Technical reference of the Eleva Padel Club academy.',
      ...
      pools: {
        ...
        active: 'Active',
        snpDay: 'Friday',    snpTime: '21:30 – 23:00',
        m4Day:  'Friday',    m4Time:  '20:20 – 21:50',
        mixDay: 'Thursday',  mixTime: '20:00 – 21:30',
        rochaDay: 'Tuesday', rochaTime: '20:00 – 21:30',
        snpDesc: 'Absolute no-handicap. For those who want to know exactly where they stand.',
        m4Desc:  'Fourth male category. Equal level, guaranteed match.',
        mixDesc: 'Open mixed. The best atmosphere of the week.',
        rochaDesc: 'Rocha category. Real competition, great vibes too.',
        perksLabel: 'All pools include',
        include: 'New balls · 1h30 · Registration via WhatsApp',
        prizeLabel: 'Winners prize',
        prize: 'BullPadel shirt with club logo',
        quote: '«There are places with more future than present.»',
        cta:   'Join the next pool'
      },
      sponsors: {
        label: 'Sponsors',
        ariaLabel: 'Main sponsors',
        headlineHtml: 'Without them,<br><em>no courts.</em>',
        sub: 'Four companies backed this project when it was just an idea. They are the real foundations of the club, and every court bears their name.',
        badge: 'Main Sponsor',
        soon: 'Coming Soon',
        soonBadge: 'Your company here?',
      },
      gallery: {
        heading: 'The club.', subtitle: 'Pizarra · Málaga · Est. 2026',
      ...
      contact: {
        ...
        labelLevel: 'Level', labelMessage: 'Message (optional)',
        ...
        formNote: 'Redirects you to WhatsApp with the filled data. Response within 24h.',
        infoPhone: 'Phone', infoInstagram: 'Instagram',
        infoAddress: 'Address', infoSchedule: 'Hours'
      },
      footer: {
        claim: 'The reference club of the Valley.',
      ...
      wa: {
        ...
        prueba:   'Hello, I\'d like to book a trial session at Eleva Padel Club Academy.',
        pool:     'Hello! I\'d like to join the next pool at Eleva Padel Club 🎾',
    ...
    nl: {
      ...
      nav: {
        ...
        contact: 'Contact', book: 'Boeken', bookCourt: 'Baan boeken',
      ...
      hero: {
        kicker: 'PADEL CLUB · 4 BUITENBANEN · PIZARRA · MÁLAGA',
      ...
      torneo: {
        flag: 'I ELEVA TOERNOOI',
        text: '24–28 Juni 2026 · 7 categorieën · €25/speler · Welcome Pack inbegrepen',
        cta: 'Inschrijven via Vola',
        ariaLabel: 'Aankomend evenement'
      },
      club: {
        label: 'De Club', aside: 'OPGERICHT · 2026 · PIZARRA · MÁLAGA',
        ...
        schedule: 'Openingstijden', scheduleValue: 'Ma–Zo · 9:00–00:00', bookings: 'Reserveringen',
        community: 'Community', communityLink: 'Actieve WhatsApp-groep',
        tournaments: 'Toernooien',
        tournamentsDesc: 'SNP Vrijdag 21:30 · 4e Heren Vrijdag 20:20<br>Gemengd Donderdag 20:00 · Rocha Dinsdag 20:00'
      },
      services: {
        ...
        desc2: 'Groepen van 3–4 personen, gecertificeerde coaches, 1u echte techniek. Lessen voor alle niveaus, van beginners tot competitie. Proeflessen beschikbaar.',
        cta2: 'Beschikbaarheid checken',
        cat3: 'Competitie', title3: 'Pools', sub3: 'Competeer elke week.',
        desc3: 'Pools per categorie: SNP, 4e, Gemengd, Rocha. Vaste prijs, geweldige sfeer gegarandeerd. Interne competitie en toernooien voor alle niveaus.',
      ...
      academy: {
        ...
        level2: 'Gevorderd', card2Title: 'Consolideer en echte tactiek.',
        ...
        level3: 'Expert / Competitie', card3Title: 'Stijg een categorie.',
        ...
        adults1dt: 'Groep van 4 · 1 dag/week', adults2dt: 'Groep van 3', adults3dt: 'Groep van 2',
        ...
        ctaNoteHtml: 'Groepen ingedeeld op niveau en beschikbaarheid.<br><strong>Beperkte plaatsen</strong> · Gecertificeerde coaches · Alle niveaus',
        ctaBtn: 'Beschikbaarheid checken'
      },
      team: {
        label: 'Het Team',
        headingHtml: 'De mensen<br><em>achter de club.</em>',
        role1: 'Coach · Professionele Speelster',
        bio1: 'Professionele padelspelster van erkend prestige en het gezicht van de club. Technisch referentiepunt van de Eleva Padel Club academie.',
      ...
      pools: {
        ...
        headingHtml: 'Competeer<br>de hele week.',
        active: 'Actief',
        snpDay: 'Vrijdag',     snpTime: '21:30 – 23:00',
        m4Day:  'Vrijdag',     m4Time:  '20:20 – 21:50',
        mixDay: 'Donderdag',   mixTime: '20:00 – 21:30',
        rochaDay: 'Dinsdag',   rochaTime: '20:00 – 21:30',
        snpDesc: 'Zonder handicap. Voor degenen die precies willen weten waar ze staan.',
        m4Desc:  'Vierde mannencategorie. Gelijk niveau, wedstrijd gegarandeerd.',
        mixDesc: 'Open gemengd. De beste sfeer van de week.',
        rochaDesc: 'Rocha categorie. Echte competitie, maar ook geweldige sfeer.',
        perksLabel: 'Alle pools omvatten',
        include: 'Nieuwe ballen · 1u30 · Inschrijving via WhatsApp',
        prizeLabel: 'Prijs winnaars',
        prize: 'BullPadel shirt met clublogo',
        quote: '«Er zijn plaatsen met meer toekomst dan heden.»',
        cta:   'Deelnemen aan de volgende pool'
      },
      sponsors: {
        label: 'Sponsors',
        ariaLabel: 'Hoofdsponsors',
        headlineHtml: 'Zonder hen,<br><em>geen banen.</em>',
        sub: 'Vier bedrijven geloofden in dit project toen het nog een idee was. Zij zijn het fundament van de club, en elke baan draagt hun naam.',
        badge: 'Hoofdsponsor',
        soon: 'Binnenkort',
        soonBadge: 'Uw bedrijf hier?',
      },
      gallery: {
        heading: 'De club.', subtitle: 'Pizarra · Málaga · Opgericht 2026',
        ariaLabel: 'Fotogalerij van de club',
        img1: 'Banen bij zonsondergang', img2: 'Detail van glas en mesh',
      ...
      contact: {
        ...
        labelLevel: 'Niveau', labelMessage: 'Bericht (optioneel)',
        phName: 'Jouw naam', phPhone: '600 000 000',
        phLevel: 'Selecteer je niveau', phMessage: 'Wil je iets toevoegen?',
        levelBeginner: 'Beginner', levelIntermediate: 'Gevorderd',
        levelAdvanced: 'Expert', levelCompetition: 'Competitie',
        submitBtn: 'Verzenden via WhatsApp',
        formNote: 'Je wordt doorgestuurd naar WhatsApp met de ingevulde gegevens. Reactie binnen 24 uur.',
        infoPhone: 'Telefoon', infoInstagram: 'Instagram',
        infoAddress: 'Adres', infoSchedule: 'Openingstijden'
      },
      footer: {
        claim: 'De referentieclub van het dal.',
        mapTitle: 'Hoe te komen', mapLink: 'Bekijken op Google Maps',
        contactTitle: 'Contact',
      ...
      wa: {
        ...
        prueba:   'Hallo, ik wil graag een proefles boeken bij Eleva Padel Club Academy.',
        pool:     'Hallo! Ik wil me graag aanmelden voor de volgende pool bij Eleva Padel Club 🎾',
