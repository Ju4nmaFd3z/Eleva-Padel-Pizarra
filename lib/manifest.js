...
(function () {
  window.__ELEVA__ = {
    ...
    brand: {
      ...
      whatsapp:      '34659143103',   // puede ser el mismo que phone
      address:       'Pasaje de Jerez S/N · 29560 Pizarra, Málaga',
      schedule:      'L–D · 9:00–00:00',
      mapEmbed:      'https://maps.google.com/maps?q=Pasaje+de+Jerez+SN+29560+Pizarra+Malaga&output=embed', // reemplazar con iframe src de Google Maps cuando esté disponible
      /* ▲ CAMBIAR antes de entregar ▲ */
