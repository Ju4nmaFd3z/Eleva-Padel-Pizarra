...
(function () {
  window.__ELEVA__ = {
    ...
    brand: {
      ...
      phone:         '34600000000',   // número sin + ni espacios, ej: 34612345678
      whatsapp:      '34600000000',   // puede ser el mismo que phone
      address:       'C/ Ejemplo 1, Pizarra, Málaga',
      schedule:      'Mañanas 9:00–12:00 · Tardes y noches 17:00–00:00',
      mapEmbed:      '',              // pega aquí el src del iframe de Google Maps
      /* ▲ CAMBIAR antes de entregar ▲ */
